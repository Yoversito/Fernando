...
const productos = [
    { nombre: 'Desodorante Axe', cantidad: 12, precioCompra: 9.90, precioVenta: 16, vendido: 7 },
    { nombre: 'Desodorante Dove F.', cantidad: 12, precioCompra: 11.50, precioVenta: 16, vendido: 3 },
    { nombre: 'Desodorante Dove M.', cantidad: 12, precioCompra: 11.50, precioVenta: 16, vendido: 1 },
    ...
    { nombre: 'Shampoo Hys 375 ml', cantidad: 12, precioCompra: 15.50, precioVenta: 19, vendido: 8 },
    { nombre: 'Shampoo Hys 650 ml', cantidad: 6, precioCompra: 23.50, precioVenta: 27, vendido: 2 },
    { nombre: 'Shampoo Pantene 400 ml', cantidad: 12, precioCompra: 15.50, precioVenta: 19, vendido: 3 },
    { nombre: 'Shampoo Sedal 340 ml', cantidad: 12, precioCompra: 9.50, precioVenta: 14, vendido: 6 },
    { nombre: 'Shampoo Ego', cantidad: 12, precioCompra: 14.50, precioVenta: 19, vendido: 1 },
    ...
    { nombre: 'Jabón Protex', cantidad: 12, precioCompra: 3.38, precioVenta: 4.50, vendido: 5 },
    { nombre: 'Jabón Palmolive', cantidad: 12, precioCompra: 3.04, precioVenta: 4.50, vendido: 2 },
    { nombre: 'Jabón Moncler', cantidad: 12, precioCompra: 3.71, precioVenta: 4.50, vendido: 2 },
    { nombre: 'Jabón Camay', cantidad: 12, precioCompra: 2.88, precioVenta: 4, vendido: 1 },
    { nombre: 'Jabón Dove', cantidad: 12, precioCompra: 3.38, precioVenta: 4.50, vendido: 2 },
    { nombre: 'Alcohol Pequeño 70°', cantidad: 24, precioCompra: 1.04, precioVenta: 2.50, vendido: 12 },
    { nombre: 'Alcohol Pequeño 96°', cantidad: 24, precioCompra: 1.13, precioVenta: 2.50, vendido: 7 },
    { nombre: 'Agua Azahar', cantidad: 12, precioCompra: 0.88, precioVenta: 2, vendido: 4 },
    { nombre: 'Agua Oxigenada', cantidad: 12, precioCompra: 0.88, precioVenta: 2, vendido: 8 },
    { nombre: 'Vinagre Tipo Bully', cantidad: 24, precioCompra: 1.13, precioVenta: 2, vendido: 9 },
    { nombre: 'Aceite de Coco', cantidad: 24, precioCompra: 0.96, precioVenta: 2, vendido: 11 },
    { nombre: 'Violeta', cantidad: 24, precioCompra: 0.96, precioVenta: 2, vendido: 6 },
    { nombre: 'Aceite Rosado', cantidad: 12, precioCompra: 1.04, precioVenta: 2.50, vendido: 1 },
    { nombre: 'Alcohol Yodado', cantidad: 12, precioCompra: 0.96, precioVenta: 1.50, vendido: 6 },
    { nombre: 'Gel Ego', cantidad: 12, precioCompra: 3.25, precioVenta: 6, vendido: 6 },
    { nombre: 'Ponds Pte. Pequeño', cantidad: 6, precioCompra: 11.17, precioVenta: 15, vendido: 3 },
    { nombre: 'Ponds Sachet', cantidad: 40, precioCompra: 0.93, precioVenta: 1.50, vendido: 30 },
];
